...
<html lang="en">
  <head>
    ...
    <title>PMS (Patient Monitoring System) - Add User</title>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="panel panel-default">
				...
				<h3 class="panel-title" align=center><b>ADD USER</b></h3>
				</div>
				<div class="panel-body">
					<div class="row text-center">
					<form class="form-horizontal" method="post">
						<div class="form-group">
							<label for="doctorID" class="col-sm-4 control-label">Doctor ID</label>
							<div class="col-sm-6">
							<input type="text" class="form-control" name="doctorID" id="doctorID" placeholder="000">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
							<input type="text" class="form-control" name="phone" id="phone" placeholder="0120000000">
							</div>
						</div>
						<div class="form-group">
							<button type="submit" class="btn btn-custom" formaction="addUserRecord.php"><i class="glyphicon glyphicon-pencil"></i><b> ADD USER</b></button>
						</div>
					</form>
					</div>
				</div>
