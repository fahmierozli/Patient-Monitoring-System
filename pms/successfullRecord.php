...
<html lang="en">
  <head>
    ...
    <title>PMS (Patient Monitoring System) - Add Record Successful</title>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="panel panel-default">
				...
				<h3 class="panel-title" align=center><b>ADD RECORDS SUCCESSFUL</b></h3>
				</div>
				<div class="panel-body">
					<div class="row text-center">
						<p>Record has been successfully saved to database.</p>
					</div>
				</div>
			</div>
		</div>  	
